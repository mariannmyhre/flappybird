...
// når siden lastes inn kalles denne funksjonen:
...
function placePipes() {
    ...
    /* the Y position of our pipe will now range from negative 1/4 to negative 3/4 of the pipe-height, somewhere between that */
...
window.addEventListener('keydown', function(e){
    if(e.keyCode == 32 && e.target == document.body) { // prevents page from scrolling when space bar is pressed
        e.preventDefault();
      }
})
